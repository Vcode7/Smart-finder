...
// All CREATE TABLE DDL statements — run once on server startup
...
export const MIGRATIONS = [
  ...
  // ─── Table Alterations for Existing Databases ───────────────────
  `ALTER TABLE video_frames ADD COLUMN frame_number INTEGER DEFAULT 0`,
  `ALTER TABLE video_frames ADD COLUMN scene_id INTEGER DEFAULT 0`,
  `ALTER TABLE video_frames ADD COLUMN visual_description TEXT`,
  `ALTER TABLE video_frames ADD COLUMN embedding BLOB`,
  `ALTER TABLE video_transcripts ADD COLUMN embedding BLOB`,
  `ALTER TABLE document_chunks ADD COLUMN embedding BLOB`,
  `ALTER TABLE images ADD COLUMN embedding BLOB`,
  `ALTER TABLE knowledge_sources ADD COLUMN frame_count INTEGER DEFAULT 0`,
];
